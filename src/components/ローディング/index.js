export default function ローディング() {
  return (
    <div className="p-8 pt-0 mx-auto bg-white rounded-md shadow animate-pulse w-76 md:w-full min-h-card dark:bg-very-dark-blue">
      ...
      <div className="mt-3">
        <h2 className="w-8/12 h-4 text-lg font-bold leading-6 bg-gray-400 rounded font-brand text-very-dark-blue dark:text-white">
          {" "}
        </h2>
      </div>
      <div>
